...
import com.example.androidglobalmanticsapp.helpers.SampleContent;
import com.example.androidglobalmanticsapp.models.Idea;
import com.example.androidglobalmanticsapp.services.IdeaService;
...
public class IdeaDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            IdeaService ideaService = ServiceBuilder.buildServices(IdeaService.class);
